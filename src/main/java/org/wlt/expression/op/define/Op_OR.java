...
//
//	/* (non-Javadoc)
//	 * @see IOperatorExecution#execute(ExpressionToken[])
//	 */
...
//			}
//		}
//		else if (first.getDataType() == BaseDataMeta.DataType.DATATYPE_OBJECT &&
//				first.getDataValue() instanceof BoolQueryBuilder )
//		{
//
//			if(second.isReference()){
//				Reference secondRef = (Reference)second.getDataValue();
...
//			builder.should((BoolQueryBuilder)first.getDataValue());
//			builder.should((BoolQueryBuilder)second.getDataValue());
//			return new Constant(BaseDataMeta.DataType.DATATYPE_OBJECT,builder);
//		}
//		else {
//			//抛异常
...
//
//	/* (non-Javadoc)
//	 * @see IOperatorExecution#verify(int, ExpressionToken[])
//	 */
