...
public class Op_MINUS implements IOperatorExecution {
	...
	/* (non-Javadoc)
	 * @see org.wltea.expression.op.define.IOperatorExectution#execute(ExpressionToken[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.wltea.expression.op.define.IOperatorExectution#verify(int, ExpressionToken[])
	 */
