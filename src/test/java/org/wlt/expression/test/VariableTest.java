...
//
//
//	public void testEsCommonQueryOperators() throws Exception
//	{
//		System.out.println("testEsCommonQueryMagic");
//
//		ArrayList<String> expressions = new ArrayList<String>();
//		//算术符
//		expressions.add("A1 &&(A2 || A3)");
//
//		BoolQueryBuilder builder1 = new BoolQueryBuilder();
//		builder1.must(QueryBuilders.termQuery("asset_code", "123456"));
//		BoolQueryBuilder builder2 = new BoolQueryBuilder();
//		builder2.must(QueryBuilders.termQuery("age", 26));
//		BoolQueryBuilder builder3 = new BoolQueryBuilder();
//		builder3.must(QueryBuilders.termQuery("sex", "male"));
//		BoolQueryBuilder builder4 = new BoolQueryBuilder();
//		builder4.must(QueryBuilders.termQuery("user_id", 1000000L));
//
//
//		//设置上下文变量
//		ArrayList<Variable> variables = new ArrayList<Variable>();
//		variables.add(Variable.createVariable("A1", builder1));
//		variables.add(Variable.createVariable("A2", builder2));
//		variables.add(Variable.createVariable("A3", builder3));
//		variables.add(Variable.createVariable("A4", builder4));
//
...
//		}
//		System.out.println("----------------------------------------------------");
//		System.out.println("----------------testEsCommonQueryMagic over------------------");
//		System.out.println("----------------------------------------------------");
//	}
//
//
